	...
	var LanguageSetting = {
		...
		bind: function(){
			...
			$('#btnLanguageOK').click(function(){	
				...
				$.contextMenu( 'destroy', '.thumbnailShowRighClickArrow,.listShowRighClickArrow' );
		...
		reloadLanguage: function(language)
		{
			...
			switch(language)
			{
				...
				case 'es':
					...
					break;	
				case 'zh':
					$('#gettingStartedImg').addClass('gettingStartedCht');
					break;
				case 'chs':
					$('#gettingStartedImg').addClass('gettingStartedChs');
					break;
				case 'rus':
					$('#gettingStartedImg').addClass('gettingStartedRus');
					break;
				case 'ko':
					$('#gettingStartedImg').addClass('gettingStartedKo');
					break;
				case 'ja':
					$('#gettingStartedImg').addClass('gettingStartedJa');
					break;
				
			}
		}		
	};
	window.LanguageSetting = LanguageSetting;
})(window);
